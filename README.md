...
To simplify the build process, cross-platform scripts are provided in the main folder:
...
- `worms`: Generates a 2D worms-like terrain.
- `texturejade`, `texturegranite`, `texturewood`, `texturesky`, `textureslime`: Create procedural textures.
