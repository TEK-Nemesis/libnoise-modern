...
int main ()
{
  ...
  // Print a message to the console to inform the user that the program has started
  std::cout << "Generating texture...\n"
            << "Please wait, this may take a while on slower computers.\n" << std::endl;
  ...
  cloudBase.SetNoiseQuality (NoiseQuality::QUALITY_BEST);
