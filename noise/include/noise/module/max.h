...
// - Used std::max instead of GetMax for modern C++ style.
...
namespace noise {
    ...
    namespace module {
        ...
        /// A noise module that outputs the larger of the two output values from two source modules.
        ///
        ...
        public:
            /// Constructor.
            Max() noexcept : Module(GetSourceModuleCount()) {}
            ...
            /// Returns the larger of the output values from the two source modules.
            ///
            ...
            ///
            /// @returns The larger of the two output values.
