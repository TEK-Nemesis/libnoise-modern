...
// - Used std::min instead of GetMin for modern C++ style.
...
namespace noise {
    ...
    namespace module {
        ...
        /// A noise module that outputs the smaller of the two output values from two source modules.
        ///
        ...
        public:
            /// Constructor.
            Min() noexcept : Module(GetSourceModuleCount()) {}
            ...
            /// Returns the smaller of the output values from the two source modules.
            ///
            ...
            ///
            /// @returns The smaller of the two output values.
